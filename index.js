...
const basepath = "C:\\webdev\\javascript\\93 clear the clutter"
let files =  await fs.readdir(basepath)
//console.log(files);

for (const item of files) {
  //   let extension = item.split(".")  //array eg output [ 'FunctionOverloading1', 'cpp' ]
  // console.log(extension);
  //last element of array is the extension
